...
router.post('/register', async (req, res) => {
    ...
    connection.query(checkEmailSql, [email], async (err, results) => {
        ...
        try {
            ...
            connection.query(insertUserSql, [fullname, email, avatar, tel, address, hashedPassword, 'Khách Hàng'], (err, userResults) => {
    ...
    connection.query(query, [email], (err, rows) => {
        ...
        connection.query(updateQuery, [resetToken, resetTokenExpiration, email], (err, result) => {
            ...
            const mailOptions = {
                ...
                to: email,
                subject: '[No-reply] - Đặt lại mật khẩu - Hương Sen – Tịnh Chay Cho Mọi Hành Trình Tâm Thức',
                html: `
